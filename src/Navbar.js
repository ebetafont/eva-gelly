...
export function Navbar(){
    ...
    let themeSite = contextData.themeSite === 'light' ? 'dark' : 'light'

    return (
        <>
            <nav className="nav">
                <Navigator className="nav-principal" />
                
                    <h1>Gamor</h1>

                    <button className="tdn-button" onClick={() => setContextData({...contextData, themeSite:themeSite})}>
...
export const Secret=()=><h2>Developer: Ernesto Betancourt</h2>
